...
$lang = array_merge($lang, array(
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Salasanan pituuden on oltava vähintään %1$s ja enintään %2$s. Siinä pitää olla sekä isoja että pieniä kirjaimia ja numeroita.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Salasanan pituuden on oltava vähintään %1$s ja enintään %2$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Salasanan pituuden on oltava vähintään %1$s ja enintään %2$s. Siinä pitää olla sekä isoja että pieniä kirjaimia.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Salasanan pituuden on oltava vähintään %1$s ja enintään %2$s. Siinä pitää olla sekä isoja että pieniä kirjaimia, numeroita ja erikoismerkkejä.',
	'PASSWORD'					=> 'Salasana',
	...
	'UCP_EMAIL_ACTIVATE'		=> 'Saat rekisteröitymisen jälkeen sähköpostiisi viestin, jossa on käyttäjätunnuksen aktivointilinkki.',
	...
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Käyttäjätunnuksen pituuden on oltava vähintään %1$s ja enintään %2$s.',
	...
	'USER_NOT_FOUND_OR_INACTIVE'	=> 'Antamaasi käyttäjätunnusta ei löytynyt tai se ei ole aktiivinen.',
